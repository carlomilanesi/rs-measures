...
define_units_relation::define_units_relation! { U1:3 == U2:3 X U2:3 }

fn main() {
    let _: Measure3d<U1> = Measure3d::<U2>::new(1.2, 1.3, 1.4).cross_product(Measure3d::<U2>::new(2.3, 2.4, 2.5));
}
