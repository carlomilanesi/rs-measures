...
define_units_relation! {SquareMetre == Metre:3 * Metre:3}
define_units_relation! {CubicMetre == SquareMetre * Metre}
define_units_relation! {SecondPerCubicMetre == Second / CubicMetre}
define_units_relation! {SquareMetrePerSquareSecond == MetrePerSecond:3 * MetrePerSecond:3}
define_units_relation! {SquareKiloGram == KiloGram * KiloGram}
define_units_relation! {Joule == KiloGram * SquareMetrePerSquareSecond}
define_units_relation! {SquareKiloGramPerMetre == SquareKiloGram / Metre}
define_units_relation! {Joule == NewtonSquareMetrePerSquareKilogram * SquareKiloGramPerMetre}
define_units_relation! {SecondPerSquareMetre:3 == Metre:3 * SecondPerCubicMetre}
define_units_relation! {KiloGramSecondPerSquareMetre:3 == SecondPerSquareMetre:3 * KiloGram}
define_units_relation! {MetrePerSecond:3 == KiloGramSecondPerSquareMetre:3 * NewtonSquareMetrePerSquareKilogram}
